...
Java_com_asiankoala_koawalib_hardware_sensor_T265Camera_newCamera(JNIEnv *env, jobject thisObj,
                                                  jstring mapPath) {
...
Java_com_asiankoala_koawalib_hardware_sensor_T265Camera_sendOdometryRaw(
...
extern "C" JNIEXPORT void JNICALL
Java_com_asiankoala_koawalib_hardware_sensor_T265Camera_exportRelocalizationMap(
...
extern "C" JNIEXPORT void JNICALL
Java_com_asiankoala_koawalib_hardware_sensor_T265Camera_setOdometryInfo(
...
extern "C" JNIEXPORT void JNICALL
Java_com_asiankoala_koawalib_hardware_sensor_T265Camera_free(JNIEnv *env, jobject thisObj) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_asiankoala_koawalib_hardware_sensor_T265Camera_cleanup(JNIEnv *env, jclass) {
std::scoped_lock lk(cleanupMutex);
